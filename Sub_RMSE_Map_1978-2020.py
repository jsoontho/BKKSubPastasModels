...
# Output: Spatial map of subsidence RMSE when compared to benchmark leveling 
# observations for whenever observations are available for each well nest
# Time period typically between 1990-2020
...
# Spatial mapping 
def forecast_map(path, wellnestlist, all_results,
        ...
        # Normalizing data
        normalized_arr = preprocessing.normalize([cs])
        ...
        js_mfs.draw_basemap(map, xs, ys, cs, fig=fig, ax=ax, 
        ...
        if save == 1:
            ...
            plt.savefig(full_figpath, dpi=150, bbox_inches='tight', format='png')
...
# Plots results, level = 2 means detailed plots
plt_tmin = "2005"; plt_tmax = "2010" # tmin and tmax for plotting

# Spatial map plotting
forecast_map(path, wellnestlist, all_results,
                 sub_total, subv_total,
